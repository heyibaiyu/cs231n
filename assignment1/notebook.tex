...
{\color{incolor}In [{\color{incolor}188}]:} \PY{c+c1}{\PYZsh{} Run some setup code for this notebook.}
...
The autoreload extension is already loaded. To reload it, use:
  \%reload\_ext autoreload
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}189}]:} \PY{c+c1}{\PYZsh{} Load the raw CIFAR\PYZhy{}10 data.}
...
Test labels shape:  (10000,)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}190}]:} \PY{c+c1}{\PYZsh{} Visualize some examples from the dataset.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}191}]:} \PY{c+c1}{\PYZsh{} Subsample the data for more efficient code execution in this exercise}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}192}]:} \PY{c+c1}{\PYZsh{} Reshape the image data into rows}
...
(5000, 3072) (500, 3072)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}204}]:} \PY{c+c1}{\PYZsh{} from cs231n.classifiers import KNearestNeighbor}
...
examples and computes the distance matrix one element at a time.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}194}]:} \PY{c+c1}{\PYZsh{} Open cs231n/classifiers/k\PYZus{}nearest\PYZus{}neighbor.py and implement}
...
(500, 5000)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}195}]:} \PY{c+c1}{\PYZsh{} We can visualize the distance matrix: each row is a single test example and}
...
\tightlist
\item
  What in the data is the cause behind the distinctly bright rows? The
  color difference is big.
\item
  What causes the columns? Training set size.
\end{itemize}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}196}]:} \PY{c+c1}{\PYZsh{} Now implement the function predict\PYZus{}labels and run the code below:}
...
try out a larger \texttt{k}, say \texttt{k\ =\ 5}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}197}]:} \PY{n}{y\PYZus{}test\PYZus{}pred} \PY{o}{=} \PY{n}{classifier}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}
          \PY{n}{num\PYZus{}correct} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{y\PYZus{}test\PYZus{}pred} \PY{o}{==} \PY{n}{y\PYZus{}test}\PY{p}{)}
          \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{num\PYZus{}correct}\PY{p}{)} \PY{o}{/} \PY{n}{num\PYZus{}test}
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Got }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{ / }\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{ correct =\PYZgt{} accuracy: }\PY{l+s+si}{\PYZpc{}f}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{num\PYZus{}correct}\PY{p}{,} \PY{n}{num\PYZus{}test}\PY{p}{,} \PY{n}{accuracy}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\emph{Your explanation}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}198}]:} \PY{c+c1}{\PYZsh{} Now lets speed up distance matrix computation by using partial vectorization}
...
Good! The distance matrices are the same
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}199}]:} \PY{c+c1}{\PYZsh{} Now implement the fully vectorized version inside compute\PYZus{}distances\PYZus{}no\PYZus{}loops}
...
Good! The distance matrices are the same
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}200}]:} \PY{c+c1}{\PYZsh{} Let\PYZsq{}s compare how fast the implementations are}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Two loop version took 30.038036 seconds
One loop version took 35.851331 seconds
No loop version took 0.222058 seconds
...
hyperparameter with cross-validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}201}]:} \PY{n}{num\PYZus{}folds} \PY{o}{=} \PY{l+m+mi}{5}
          ...
          \PY{n}{X\PYZus{}train\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array\PYZus{}split}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{)}
          \PY{n}{y\PYZus{}train\PYZus{}folds} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array\PYZus{}split}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{)}
          ...
          \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
              \PY{n}{f\PYZus{}train\PYZus{}x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{empty}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{X\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{)}
              \PY{n}{f\PYZus{}train\PYZus{}y} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{empty}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
              \PY{n}{f\PYZus{}test\PYZus{}x} \PY{o}{=} \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
              \PY{n}{f\PYZus{}test\PYZus{}y} \PY{o}{=} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
              
              \PY{c+c1}{\PYZsh{} prepare training and validation data for ith fold}
              \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i}\PY{p}{)}\PY{p}{:}
                  \PY{n}{np}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{f\PYZus{}train\PYZus{}x}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
                  \PY{n}{np}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{f\PYZus{}train\PYZus{}y}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
              
              \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
                  \PY{n}{np}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{f\PYZus{}train\PYZus{}x}\PY{p}{,} \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
                  \PY{n}{np}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{f\PYZus{}train\PYZus{}y}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}
              
              \PY{n}{classifier}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{f\PYZus{}train\PYZus{}x}\PY{p}{,} \PY{n}{f\PYZus{}train\PYZus{}y}\PY{p}{)}
              \PY{n}{dists} \PY{o}{=} \PY{n}{classifier}\PY{o}{.}\PY{n}{compute\PYZus{}distances\PYZus{}no\PYZus{}loops}\PY{p}{(}\PY{n}{f\PYZus{}test\PYZus{}x}\PY{p}{)}
              
              \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{k\PYZus{}choices}\PY{p}{:}
                  \PY{n}{y\PYZus{}test\PYZus{}pred} \PY{o}{=} \PY{n}{classifier}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists}\PY{p}{,} \PY{n}{k}\PY{p}{)}
                  \PY{c+c1}{\PYZsh{} Compute and print the fraction of correctly predicted examples}
                  \PY{n}{num\PYZus{}correct} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{y\PYZus{}test\PYZus{}pred} \PY{o}{==} \PY{n}{f\PYZus{}test\PYZus{}y}\PY{p}{)}
                  \PY{n}{accuracy} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{num\PYZus{}correct}\PY{p}{)} \PY{o}{/} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{size}
                  \PY{n}{k\PYZus{}to\PYZus{}accuracies}\PY{p}{[}\PY{n}{k}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{accuracy}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-201-2d22f62bff4e> in <module>()
         56 
         57     for k in k\_choices:
    ---> 58         y\_test\_pred = classifier.predict\_labels(dists, k)
         59         \# Compute and print the fraction of correctly predicted examples
         60         num\_correct = np.sum(y\_test\_pred == f\_test\_y)


        \textasciitilde{}/Downloads/assignment1/cs231n/classifiers/k\_nearest\_neighbor.py in predict\_labels(self, dists, k)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} plot the raw observations}
        \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{k\PYZus{}choices}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Based on the cross\PYZhy{}validation results above, choose the best value for k,   }
        ...
        \PY{n}{best\PYZus{}k} \PY{o}{=} \PY{l+m+mi}{1}
